...
== Default actions
Default crud actions are included. Generic variables <tt>@item</tt> (index) and <tt>@items</tt> are provided, but also with the specific name like <tt>@vacancy</tt> or <tt>@vacancies</tt>. Controllername should match modelname. You can overwrite the actions in the controller.
