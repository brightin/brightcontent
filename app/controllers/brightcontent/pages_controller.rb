class Brightcontent::PagesController < Brightcontent::ApplicationController
  def create
    super
    @page.insert_at(params[:page][:position].to_i || 1) unless @page.new_record?
  end
  ...
  def update
    ...
    @page.insert_at(params[:page][:position].to_i || 1)
    super
  end  
